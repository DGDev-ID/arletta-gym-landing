...
<template>
  <div
    ...
    style="background: linear-gradient(145deg, #1a1a1a 0%, #111 100%); box-shadow: 0 0 24px rgba(0,0,0,0.5);"
  >
    ...
    <div
      ...
      style="background: rgba(var(--primary-rgb, 239,68,68), 0.15); color: var(--primary); border: 1px solid var(--primary);"
    >
      Couple
    </div>
